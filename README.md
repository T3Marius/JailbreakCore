...
- [x] Connecting laser during LR prep timer - Draw laser between guardian and prisoner during preparation
- [x] Last request beacons - Circular beacons under guardian and prisoner during active LR
